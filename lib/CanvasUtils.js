  ...
  textMetrics.lines.forEach(function (line, lineIdx, lines) {
    ...
    if (currY <= (height + y)) {
      ...
      // Slow path. Full justification. Set each word individually.
        ...
        // This is a little noisy in JavaScript. Compare Haskell:
        // advanceWidths = scanl (\x y -> spaceWidth + x + y) 0 . map width $ words
        // or Clojure:
        // (def advanceWidths (reductions #(+ spaceWidth %1 %2) 0 (map #(get % :width) words)))
